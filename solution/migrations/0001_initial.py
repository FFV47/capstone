    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("min_salary", models.FloatField(validators=[django.core.validators.MinValueValidator(0)])),
                (
                    "max_salary",
                    models.FloatField(
                        validators=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "job",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="work_schedules", to="solution.job"
                    ),
                ),
            ],
        ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ImageField(
                        ...
                        validators=[
                            solution.validators.FileValidator(content_types=("image/jpeg", "image/png"), max_size=3)
                        ],
                    ),
                ),
                (
                ...
                ("jobs_done", models.IntegerField(validators=[django.core.validators.MinValueValidator(0)])),
                ("location", models.CharField(max_length=255)),
                ...
                (
                    "role",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="professionals", to="solution.role"
                    ),
                ),
                (
                    "user",
